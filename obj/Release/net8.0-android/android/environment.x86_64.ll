...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2205550543690182931, ; hash 0x1e9bb088b2d2b113, from name: aot-SoftwareSystemOrders
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 3513037499093177759, ; hash 0x30c0d0fe1813559f, from name: aot-SoftwareSystemOrders.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SoftwareSystemOrders.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	...
	%struct.DSOCacheEntry {
		i64 4411816402697093404, ; hash 0x3d39eba4b900811c, from name: libaot-SoftwareSystemOrders
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SoftwareSystemOrders.dll.so
		ptr null; void* handle (0x0)
	}, ; 114
	...
	%struct.DSOCacheEntry {
		i64 6257646607070293965, ; hash 0x56d7a06f485a6fcd, from name: SoftwareSystemOrders.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SoftwareSystemOrders.dll.so
		ptr null; void* handle (0x0)
	}, ; 143
	...
	%struct.DSOCacheEntry {
		i64 9356976281343155332, ; hash 0x81daa85a3d36dc84, from name: SoftwareSystemOrders
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SoftwareSystemOrders.dll.so
		ptr null; void* handle (0x0)
	}, ; 247
	...
	%struct.DSOCacheEntry {
		i64 17707062158445686480, ; hash 0xf5bc1f3791eaaed0, from name: libaot-SoftwareSystemOrders.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SoftwareSystemOrders.dll.so
		ptr null; void* handle (0x0)
	}, ; 468
...
@.env.3 = private unnamed_addr constant [37 x i8] c"66991486-9eec-4363-aa79-5b5910b84d32\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [37 x i8] c"com.companyname.softwaresystemorders\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [35 x i8] c"libaot-SoftwareSystemOrders.dll.so\00", align 16
